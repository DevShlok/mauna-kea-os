...
- **Top-Level Dynamic Hover Navigation**: Converted Legal & Finance sub-sections into 4 top-level sidebar headings (**Contracts**, **Invoices**, **Reports**, **Governance**) in `Sidebar.tsx`. Each heading opens its dynamic layer of sub-items seamlessly on hover, exactly matching standard dashboard category behavior.
