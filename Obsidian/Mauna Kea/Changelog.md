...
- **Enhanced Sidebar Typography & Legibility**: Increased overall font size across all sidebar layers in `Sidebar.tsx` (Layer 1 headers to `15.5px`, Layer 2 sub-headings to `14.5px`, and Layer 3 menu items to `13.5px`–`14.5px`), and expanded sidebar width to `285px` for optimal readability and spacing.
