...
- **Dashboard Navigation Hierarchy**: Reorganized `Sidebar.tsx` under Legal & Finance to cleanly group Contracts (Repository, Create, Templates), Invoices (Repository, Raise, Payments, Credit Notes), and Reports (Revenue, Outstanding, Renewals, Collection).
