    ...
    <div className="max-w-screen-xl mx-auto pb-10">
      ...
      <div className="bg-white border border-[#D4E0F0] rounded-[10px] p-6 mb-6 shadow-sm flex items-start gap-5">
        ...
        <div className="flex-1">
          ...
          <div className="flex gap-2 mt-2">
            <Link href="/dashboard/float-list" className="px-3 py-1.5 rounded-md text-[14px] font-semibold text-[#6b7a99] hover:bg-[#f4f7fd] transition-all border border-[#D4E0F0]">← Back</Link>
      ...
      <div className="flex flex-col mb-6">
        ...
        <Tile 
          ...
          content={
            <div>
              <div className="border-2 border-dashed border-[#D4E0F0] rounded-[10px] p-6 text-center cursor-pointer hover:border-[#133255] bg-[#f4f7fd] transition-colors relative mb-3">
                ...
                <div className="text-[25px] mb-2">📎</div>
                <div className="font-semibold text-[#111] mb-1 text-[16px]">{candidate.hasCv ? 'Replace CV' : 'Upload CV'}</div>
                <div className="text-[14px] text-[#6b7a99]">{isUploading ? 'Uploading...' : 'PDF format'}</div>
              </div>

              {candidate.hasCv && (
                <div className="flex items-center gap-2 p-2 bg-[#f4f7fd] rounded-md text-[15px] mb-3">
                  <span>📄</span>
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noreferrer" 
                    className="px-3 py-1 bg-white text-[#133255] rounded text-[14px] font-bold border border-[#D4E0F0] hover:bg-gray-50 z-20"
                    onClick={(e) => {
              ...
              {candidate.linkedinPdf && (
                <div className="flex items-center gap-2 p-2 bg-[#f0f9ff] rounded-md text-[15px] mb-3 border border-[#bae6fd]">
                  <span>📘</span>
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noreferrer" 
                    className="px-3 py-1 bg-white text-[#0369a1] rounded text-[14px] font-bold border border-[#bae6fd] hover:bg-white z-20"
                    onClick={(e) => {
