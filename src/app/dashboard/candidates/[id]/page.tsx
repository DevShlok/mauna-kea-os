...
export default function CandidateProfilePage() {
  ...
  const candidate = mandate?.candidates.find((c) => c.id === id) || mandate?.candidates[0];
    ...
    <div className="max-w-screen-xl mx-auto pb-10">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm flex items-start gap-5 mb-6">
        ...
        <div className="flex gap-2">
          ...
          <button className="px-4 py-2 border border-gray-200 text-gray-600 rounded text-xs font-bold hover:bg-gray-50">Download Report</button>
        </div>
      </div>
