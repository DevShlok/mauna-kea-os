          ...
          <div className="backdrop-blur-xl bg-white/[0.04] rounded-2xl border border-white/[0.08] shadow-[0_8px_60px_rgba(0,0,0,0.4)] overflow-hidden">
            ...
            <div className="px-8 pt-6 pb-8">
              ...
              <div className="w-full flex items-center my-7">
                ...
                <span className="px-4 text-[10px] font-medium text-white/25 uppercase tracking-[0.15em]">or sign up with email</span>
                <div className="flex-1 h-px bg-white/[0.08]"></div>
              </div>

              <form className="w-full flex flex-col gap-5" onSubmit={handleSignUp}>
                <div className="flex flex-col gap-2">
                  <label className="text-[11px] font-semibold tracking-[0.1em] uppercase text-white/40">Full Name</label>
                  <input
                    type="text"
                    required
