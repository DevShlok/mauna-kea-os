...
const noticeRegex = /<span className="text-\[14px\] text-\[#6b7a99\]">Notice: \{candidate\.notice\} days<\/span>/g;
...
code = code.replace(noticeRegex, newProfileTags);

// 3. Inject Stability and Relocation in the main details block or as a new box
// Let's create a new box for these under the top block
const topBlockEndRegex = /<\/div>\s*<\/div>\s*\{candidate\.hasCv &&/g;
...
console.log('Updated FlCandidateClient');
